...
# Решение
## Задание 1
01.xlsx Создадим и заполним слева "таблицу значений" из задания:
...
## Задание 2
02.xlsx Вверху создадим таблицу "Условие 1" и внесем значения из первого условия задачи:
...
03.xlsx Создадим и заполним таблицу, состоящую из трех частей:
